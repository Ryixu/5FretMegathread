𝙏𝙝𝙞𝙨 𝙞𝙨 𝙖 𝙤𝙥𝙚𝙣 𝙨𝙤𝙪𝙧𝙘𝙚 𝙢𝙚𝙜𝙖𝙩𝙝𝙧𝙚𝙖𝙙 𝙛𝙤𝙧 𝙚𝙫𝙚𝙧𝙮𝙩𝙝𝙞𝙣𝙜 𝙂𝙪𝙞𝙩𝙖𝙧 𝙃𝙚𝙧𝙤 𝙖𝙣𝙙 𝙍𝙤𝙘𝙠 𝘽𝙖𝙣𝙙 𝙧𝙚𝙡𝙖𝙩𝙚𝙙! 𝙄𝙛 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙖𝙙𝙙 𝙨𝙤𝙢𝙚𝙩𝙝𝙞𝙣𝙜 𝙩𝙤 𝙩𝙝𝙚 𝙡𝙞𝙨𝙩 𝙤𝙧 𝙚𝙙𝙞𝙩 𝙞𝙩 𝙛𝙚𝙚𝙡 𝙛𝙧𝙚𝙚 𝙩𝙤 𝙢𝙖𝙠𝙚 𝙖 𝙥𝙪𝙡𝙡 𝙧𝙚𝙦𝙪𝙚𝙨𝙩!

## TABLE OF CONTENTS
- [Discord Servers](#discords)
- [Community Socials](#community-socials)
- [Game Links](#games)
- [Quality of Life Mods](#quality-of-life-mods)
- [Charts / Songs](#charts--songs)
- [Hardware](#hardware)
- [Streaming Tools](#streaming-tools)
- [Emulators](#emulators)
- [Hardware Tools / Software](#hardware-tools--software)
...
- Clones
  - [Clone Hero](https://clonehero.net) - Guitar Hero PC / Android Clone.
  - [Yet Another Rhythm Game](https://yarg.in) - Rock Band PC Clone.
  - [Encore](https://github.com/Encore-Developers/Encore) - WIP Fortnite Festival Clone.
...
* [Amplitude Deluxe](https://github.com/hmxmilohax/Amplitude-2016-Deluxe#readme) - Deluxe for Amplitude!
* [Guitar Hero II Deluxe](https://gh2dx.milohax.org) - Deluxe for Guitar Hero II.
* [Guitar Hero III](https://github.com/nsneverhax/guitar-hero-3-deluxe#readme) - Deluxe for Guitar Hero III. *(Can be used with 'Guitar Hero III+')*
* [GH3PC+](https://drive.google.com/drive/folders/1UNnDSeiN4zZDu5Xp0ZPfesJSnesd9ZOn) - Old Mod for Guitar Hero III. *(Only use with Deluxe if you want Hopo Chords, Tap Notes(replaces battle notes), Open Notes)*
* [Guitar Hero World Tour: Definitive Edition](https://ghwt.de/) - Guitar Hero World Tour Quality of Life Mod in vein with the Deluxe Mods.
* [Rock Band Patches](https://github.com/hmxmilohax/rb-patches) - Extra Rock Band Patches. *(Can be used with Rock Band Deluxe)*
* [Rock Band 2 Deluxe](https://rb2dx.milohax.org) - Deluxe for Rock Band 2.
* [Rock Band 3 Deluxe](https://rb3dx.milohax.org) - Deluxe for Rock Band 3.
* [Rock Band 4 Deluxe](https://github.com/hmxmilohax/Rock-Band-4-Deluxe#readme) - Deluxe for Rock Band 4.
* [Warriors of Rock+](https://github.com/kernaltrap8/WoR-Plus) - Guitar Hero Warriors of Rock Quality of Life Mod in vein with the Deluxe Mods.

## CHARTS / SONGS
* [Bridge](https://github.com/Geomitron/Bridge/releases/tag/v3.4.5) - Chorus Encore in application form.
* [Chorus Encore](https://www.enchor.us/) - Chart hosting site. *(Focuses on native PC charts)*
* [Rhythmverse](https://rhythmverse.co/) - Chart hosting site. *(Focuses on native Console charts)*
* [Chart Commision Spreadsheet](https://docs.google.com/spreadsheets/d/1B_JHc8FvpHqAYcCJKHSzTF-6yZE8wU_eeq2TDKszgl4/edit?gid=0#gid=0) - Spreadsheet for easily finding open Chart commisions!
...
* [CRKD](https://crkd.gg/) - The old team from Red Octane who specialize in switch controllers who created a NEW OFFICAL Les Paul!
* [Blue Indigo Adapter](https://www.etsy.com/listing/1397089947/blue-indigo-v4-playstation-2-guitar) - Play Station 2 Guitar Adapter.

## STREAMING TOOLS
* [InputJuice](https://github.com/Ryixu/InputJuice/releases/tag/v1.0.0) - Input Display.
* [Yet Another Input Display](https://github.com/raphaelgoulart/ya_inputdisplay) - Input Display.
* [Ouvert](https://ouvert.dev/) - Song Request Bot.
  
## EMULATORS
* [Dolphin](https://dolphin-emu.org/) - Wii Emulator.
* [PCSX2](https://pcsx2.net/) - PlayStation 2 Emulator.
* [PS3 Disc Dumper](https://github.com/13xforever/ps3-disc-dumper/releases) - PlayStation 3 Disc Dumper! *(Get your stuff legally bro.)* 
...
* [Xenia](https://xenia.jp/) - Xbox 360 Emulator *(The motherboard Xenia emulates causes these games to run very poorly. Use RPCS3 Instead!)*
  
## HARDWARE TOOLS / SOFTWARE
* [Festival Instrument Mapper](https://github.com/InvoxiPlayGames/FestivalInstrumentMapper) - Makes your guitar compatible with Fornite Festival.
* [Rock Band Instrument Mapper](https://github.com/TheNathannator/RB4InstrumentMapper/releases) - Makes your Rock Band guitar compatible with Clone Hero.
* [Santroller](https://github.com/Santroller/Santroller) - Basic Santroller. *(If you are using a RCM or Phunky Kit/Guitar please use their respective fork of santroller.)*
* [PhunkyCustoms Santroller](https://drive.google.com/drive/folders/1gAYrJRi0iubkYDDKyf2FjI4CX1cJlRy6) - Santroller but for Phunky Kits.
* [RCM Santroller](https://retrocultmods.com/programming-tool/) - Santroller but for RCM Kits.
